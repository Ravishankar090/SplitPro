...
export default function LoginPage() {
  ...
  return (
    <div style={{ flex:1, display:"flex", flexDirection:"column",
      ...
      {error && (
        <p style={{ fontSize:13, color:"var(--c-accent)",
          marginBottom:12 }}>{error}</p>
      )}

      <button className="btn-primary" onClick={submit} disabled={!email||!password||loading}>
